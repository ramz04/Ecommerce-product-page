...
function LightBoxOpen(){
  ...
  return (
    <div className='home--page md:px-[10rem] md:grid md:grid-cols-2 md:mt-20'>
      ...
      <div className='h-full hidden md:flex flex-col'>
        <div onClick={LightBoxOpen} className='cursor-pointer'><img src={data[currentIndex].url} className='rounded-lg'/></div>
  ...
  durable rubber outer sole, they’ll withstand everything the weather can offer.</p>
      ...
      <div className='md:flex md:gap-4'>
        ...
        <div type='button' className='w-full md:basis-3/5 flex items-center justify-center mt-4 py-3 rounded-lg bg-Orange gap-4 hover:bg-opacity-75 transition-shadow ease-in-out'>
