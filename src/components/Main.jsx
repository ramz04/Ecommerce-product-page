...
function subtract(){
  ...
  return (
    <div className='home--page md:px-[8rem]'>
  ...
  durable rubber outer sole, they’ll withstand everything the weather can offer.</p>
      ...
      <div className='mt-3 w-full bg-Lightgrayishblue flex justify-between items-center rounded-lg p-4'>
      ...
      <div type='button' className='w-full flex items-center justify-center mt-4 py-3 rounded-lg bg-Orange gap-4 hover:bg-Paleorange transition-shadow ease-in-out'>
