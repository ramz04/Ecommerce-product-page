...
function LightBoxOpen(){
  ...
  durable rubber outer sole, they’ll withstand everything the weather can offer.</p>
      ...
      <div className='md:flex md:gap-4'>
        ...
        <div type='button' className='w-full md:basis-3/5 flex items-center justify-center mt-4 py-3 md:py-2 rounded-lg bg-Orange gap-4 hover:bg-opacity-75 transition-shadow ease-in-out'>
